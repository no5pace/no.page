...
bascially this will be a website from which i host my discord bot and have general info about the stuff i do (links to github + replit)
...
> host discord bot from this website, and link to github + replit where there'll be invite links, and documentation for each bot
> share my projects + source code using github + replit 

Execution:
> make the discord bot lol
